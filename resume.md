...
- Designed or configured [brief description].
- Applied [technical skills or concepts].
- Collaborated with [team or partner], with responsibility for [individual contribution].
- Improved the project by [revision, testing, troubleshooting, or feedback].
...
- Investigated or solved [technical problem].
- Collected and analyzed [data, logs, user feedback, test results, or other evidence].
- Presented findings through [report, demonstration, presentation, or portfolio artifact].
...
- [Honor roll, competition result, scholarship, or other recognition], [Year]
